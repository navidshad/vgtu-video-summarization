					...
					<div v-for="thread in videoStore.threads" :key="thread.id"
						...
						<Card
							...
							<div class="p-5 flex flex-col h-full">
								...
								<div
									class="mt-4 pt-4 border-t border-zinc-100 dark:border-zinc-800 flex items-center justify-between text-xs text-zinc-500 dark:text-zinc-400">
									...
									<div class="flex items-center space-x-3">
										<div class="flex items-center">
											...
											{{ getThreadTotals(thread).tokens.toLocaleString() }}
										</div>
										<div class="flex items-center font-bold text-zinc-700 dark:text-zinc-300">
